...
//
// ASCOM Telescope hardware class for CCDASTROTemma
//
    ...
    internal static class TelescopeHardware
    {
        ...
        static TelescopeHardware()
        {
            try
            {
                ...
                tl = new TraceLogger("", "CCDASTROTemma.Hardware");
            ...
            catch (Exception ex)
            {
                ...
                MessageBox.Show($"{ex.Message}", "Exception creating ASCOM.CCDASTROTemma.Telescope", MessageBoxButtons.OK, MessageBoxIcon.Error);
                throw;
            }
        }
